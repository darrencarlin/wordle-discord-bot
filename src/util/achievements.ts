...
export const achievements = [
  {
    ...
    check: (userData: User) => {
      if (
        ...
        !userData.achievements.find((achievement) => achievement.id === 1)
      ) {
        return {
          id: 1,
          name: "Getting wordly",
  ...
  },
  {
    ...
    check: (userData: User) => {
      if (
        ...
        !userData.achievements.find((achievement) => achievement.id === 2)
      ) {
        return {
          id: 2,
          name: "Getting wordly",
  ...
  },
  {
    ...
    check: (userData: User) => {
      if (
        ...
        !userData.achievements.find((achievement) => achievement.id === 3)
      ) {
        return {
          id: 3,
          name: "Getting wordly",
  ...
  },
  {
    ...
    check: (userData: User) => {
      if (
        ...
        !userData.achievements.find((achievement) => achievement.id === 4)
      ) {
        return {
          id: 4,
          name: "Getting wordly",
  ...
  },
  {
    ...
    check: (userData: User) => {
      if (
        ...
        !userData.achievements.find((achievement) => achievement.id === 5)
      ) {
        return {
          id: 5,
          name: "Getting wordly",
  ...
  },
  {
    ...
    check: (userData: User) => {
      if (
        ...
        !userData.achievements.find((achievement) => achievement.id === 6)
      ) {
        return {
          id: 6,
          name: "Getting wordly",
  ...
  },
  {
    ...
    check: (userData: User) => {
      if (
        ...
        !userData.achievements.find((achievement) => achievement.id === 7)
      ) {
        return {
          id: 7,
          name: "Streaking",
  ...
  },
  {
    ...
    check: (userData: User) => {
      if (
        ...
        !userData.achievements.find((achievement) => achievement.id === 8)
      ) {
        return {
          id: 8,
          name: "Streaking",
  ...
  },
  {
    ...
    check: (userData: User) => {
      if (
        ...
        !userData.achievements.find((achievement) => achievement.id === 9)
      ) {
        return {
          id: 9,
          name: "Streaking",
  ...
  },
  {
    ...
    check: (userData: User) => {
      if (
        ...
        !userData.achievements.find((achievement) => achievement.id === 10)
      ) {
        return {
          id: 10,
          name: "Streaking",
  ...
  },
  {
    ...
    check: (userData: User) => {
      if (
        ...
        !userData.achievements.find((achievement) => achievement.id === 11)
      ) {
        return {
          id: 11,
          name: "Streaking",
  ...
  },
  {
    ...
    check: (userData: User) => {
      if (
        ...
        !userData.achievements.find((achievement) => achievement.id === 12)
      ) {
        return {
          id: 12,
          name: "Hard luck",
  ...
  },
  {
    ...
    check: (userData: User) => {
      if (
        ...
        !userData.achievements.find((achievement) => achievement.id === 13)
      ) {
        return {
          id: 13,
          name: "Wordle in 1",
  ...
  },
  {
    ...
    check: (userData: User) => {
      if (
        ...
        !userData.achievements.find((achievement) => achievement.id === 14)
      ) {
        return {
          id: 14,
          name: "Wordle in 2",
  ...
  },
  {
    ...
    check: (userData: User) => {
      if (
        ...
        !userData.achievements.find((achievement) => achievement.id === 15)
      ) {
        return {
          id: 15,
          name: "Wordle in 3",
  ...
  },
  {
    ...
    check: (userData: User) => {
      ...
      if (
        ...
        !userData.achievements.find((achievement) => achievement.id === 16)
      ) {
        return {
          id: 16,
          name: "Triple wordle",
  ...
  },
  {
    ...
    check: (userData: User) => {
      if (
        userData.achievements.length === 17 &&
        !userData.achievements.find((achievement) => achievement.id === 17)
      ) {
        return {
          id: 17,
          name: "Completed all achievements",
